package no.connectica.robocop.data.provider;

import no.connectica.robocop.data.database.AgendaDatabase;

import no.connectica.robocop.data.database.table.*;
...
public class AgendaProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "no.connectica.robocop.data.provider";
